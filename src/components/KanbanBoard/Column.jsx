...
export default function Column({ title, tasks, id }) {
  return (
    ...
    >
      <div className={`p-3 w-full flex items-center justify-between bg-[#262626] sticky top-0 rounded-b-md ${
          id == "1"
            ? "text-[#9C6DF3] "
            : id == "2"
            ? "text-[#EB7D44] "
      ...
      <i title="add" className=" cursor-pointer max-sm:text-xs text-xl ri-add-fill"></i>
      </div>
